...
| `GATE_BRIDGE_GAP.md` | LIVE | The one remaining open gap to close the cubic gate (2026-06-13): bridging the cubic static front to the DEDUPED opened-row ledger. A design point (square-sum is quintic, the list is exponential; the bound must come from suffix-sharing). Framed for a GPT Pro design pass. |
