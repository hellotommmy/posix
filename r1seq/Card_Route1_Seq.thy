...
lemma single_root_RSEQ_RSTAR_root_boundary_RCHAR_RALTS_single_from_branch_tail_cases_clean:
  assumes rchar_rseq_tail:
    "\<And>c u1 u2. legacy_rrexp (RSEQ u1 u2) \<Longrightarrow>
      rntimes_free (RSEQ u1 u2) \<Longrightarrow> apder_nf (RSEQ u1 u2) \<Longrightarrow>
      card ((single_root (RSEQ (RSTAR r) (RALTS [RSEQ (RCHAR c) (RSEQ u1 u2)])) (RCHAR a) -
    ...
    "\<And>q1 q2. legacy_rrexp (RSEQ q1 q2) \<Longrightarrow>
      ...
      card ((single_root (RSEQ (RSTAR r) (RALTS [RSEQ q1 q2])) (RCHAR a) -
        ...
        (B (rsimp4_SEQ_atom (RSTAR r)
          ...
          (B (RCHAR a) \<union>
            B (rsimp4_SEQ_atom (RALTS [RSEQ q1 q2]) (RCHAR a))))) \<le> 1"
    by (rule single_root_RSEQ_RSTAR_root_boundary_RCHAR_RALTS_single_RSEQ_from_left_tail_cases_clean
        [OF rchar_rseq_tail rchar_ralts_tail rstar_rseq_tail rstar_ralts_tail ralts_left])
  show ?thesis
    by (rule single_root_RSEQ_RSTAR_root_boundary_RCHAR_RALTS_single_from_branch_cases_clean
        [OF rseq_branch clean])
qed
...
lemma single_root_RSEQ_RSTAR_root_boundary_RCHAR_RALTS_single_RSEQ_RALTS_single_from_tail_cases_clean:
  assumes rseq_tail:
    "\<And>u1 u2. legacy_rrexp (RSEQ u1 u2) \<Longrightarrow>
      rntimes_free (RSEQ u1 u2) \<Longrightarrow> apder_nf (RSEQ u1 u2) \<Longrightarrow>
      card ((single_root (RSEQ (RSTAR r) (RALTS [RSEQ (RALTS [RCHAR c]) (RSEQ u1 u2)])) (RCHAR a) -
        B (rsimp4_SEQ_atom (RSTAR r)
          (rsimp4_SEQ_atom (RALTS [RSEQ (RALTS [RCHAR c]) (RSEQ u1 u2)]) (RCHAR a)))) \<union>
        (B (rsimp4_SEQ_atom (RSTAR r)
          (rsimp4_SEQ_atom (RALTS [RSEQ (RALTS [RCHAR c]) (RSEQ u1 u2)]) (RCHAR a))) -
          (B (RCHAR a) \<union>
            B (rsimp4_SEQ_atom (RALTS [RSEQ (RALTS [RCHAR c]) (RSEQ u1 u2)]) (RCHAR a))))) \<le> 1"
    and ralts_tail:
    "\<And>rs. legacy_rrexp (RALTS rs) \<Longrightarrow>
      rntimes_free (RALTS rs) \<Longrightarrow> apder_nf (RALTS rs) \<Longrightarrow>
      card ((single_root (RSEQ (RSTAR r) (RALTS [RSEQ (RALTS [RCHAR c]) (RALTS rs)])) (RCHAR a) -
        B (rsimp4_SEQ_atom (RSTAR r)
          (rsimp4_SEQ_atom (RALTS [RSEQ (RALTS [RCHAR c]) (RALTS rs)]) (RCHAR a)))) \<union>
        (B (rsimp4_SEQ_atom (RSTAR r)
          (rsimp4_SEQ_atom (RALTS [RSEQ (RALTS [RCHAR c]) (RALTS rs)]) (RCHAR a))) -
          (B (RCHAR a) \<union>
            B (rsimp4_SEQ_atom (RALTS [RSEQ (RALTS [RCHAR c]) (RALTS rs)]) (RCHAR a))))) \<le> 1"
    and clean: "legacy_rrexp u" "rntimes_free u" "apder_nf u"
      "u \<noteq> RZERO" "u \<noteq> RONE"
  shows "card ((single_root (RSEQ (RSTAR r) (RALTS [RSEQ (RALTS [RCHAR c]) u])) (RCHAR a) -
      B (rsimp4_SEQ_atom (RSTAR r)
        (rsimp4_SEQ_atom (RALTS [RSEQ (RALTS [RCHAR c]) u]) (RCHAR a)))) \<union>
      (B (rsimp4_SEQ_atom (RSTAR r)
        (rsimp4_SEQ_atom (RALTS [RSEQ (RALTS [RCHAR c]) u]) (RCHAR a))) -
        (B (RCHAR a) \<union>
          B (rsimp4_SEQ_atom (RALTS [RSEQ (RALTS [RCHAR c]) u]) (RCHAR a))))) \<le> 1"
  using clean
proof (cases u)
  case RZERO
  then show ?thesis using clean by simp
  ...
  have leaf:
    "card ((single_root
      ...
      (B (rsimp4_SEQ_atom (RSTAR r)
        ...
        (B (RCHAR a) \<union>
          B (rsimp4_SEQ_atom (RALTS [RSEQ (RALTS [RCHAR c]) (RCHAR e)]) (RCHAR a))))) \<le> 1"
    by (rule single_root_RSEQ_RSTAR_root_boundary_RCHAR_RALTS_single_RSEQ_RALTS_single_RCHAR)
  show ?thesis using RCHAR leaf by simp
next
  case (RSEQ u1 u2)
  have leaf:
  ...
  have leaf:
    "card ((single_root
      ...
      (B (rsimp4_SEQ_atom (RSTAR r)
        ...
        (B (RCHAR a) \<union>
          B (rsimp4_SEQ_atom (RALTS [RSEQ (RALTS [RCHAR c]) (RSTAR e)]) (RCHAR a))))) \<le> 1"
    by (rule single_root_RSEQ_RSTAR_root_boundary_RCHAR_RALTS_single_RSEQ_RALTS_single_RSTAR)
  show ?thesis using RSTAR leaf by simp
next
  case (RNTIMES e n)
  then show ?thesis using clean by simp
...
lemma seq_head_core_RALTS_le_rsize_from_L1:
  fixes rs t k
  defines "c \<equiv> rsimp4_SEQ_atom t k"
  assumes L1_cover:
    "single_root (RSEQ (RALTS rs) t) k
      \<subseteq> ((\<Union>q \<in> set rs.
        single_root (RSEQ q t) k \<union> single_term q c) \<union> B k \<union> B c)"
    and branches:
    "\<And>q. q \<in> set rs \<Longrightarrow>
      card ((single_root (RSEQ q t) k \<union> single_term q c) -
        (B k \<union> B c)) \<le> rsize q"
...
proof -
  ...
  have root_sub:
    "single_root (RSEQ (RALTS rs) t) k
      \<subseteq> (\<Union>q \<in> set rs. ?F q) \<union> ?Base"
    using L1_cover by auto
  have term_sub:
    "single_term (RALTS rs) c \<subseteq> (\<Union>q \<in> set rs. ?F q)"
    by auto
  have diff_sub:
    "(single_root (RSEQ (RALTS rs) t) k \<union> single_term (RALTS rs) c) -
       ?Base \<subseteq> (\<Union>q \<in> set rs. ?F q) - ?Base"
    using root_sub term_sub by auto
  have "card ((single_root (RSEQ (RALTS rs) t) k \<union>
             single_term (RALTS rs) c) - ?Base) \<le>
      card ((\<Union>q \<in> set rs. ?F q) - ?Base)"
    by (rule card_mono) (use diff_sub in auto)
  also have "... \<le> sum_list (map rsize rs)"
...
lemma D1_singleton_le_rsize_from_required_head_suc_boundary_L1_clean:
  assumes L1:
    "\<And>rs k. A (RALTS [RALTS rs]) k \<subseteq>
      (\<Union>q \<in> set rs. A (RALTS [q]) k)"
    and seq_head:
...
lemma D1_singleton_le_rsize_from_seq_head_cases_boundary_L1_root_clean:
  assumes L1:
    "\<And>rs k. A (RALTS [RALTS rs]) k \<subseteq>
      (\<Union>q \<in> set rs. A (RALTS [q]) k)"
    and rone_diff:
...
lemma combined_RSEQ_le_rsize_from_required_head_suc_boundary_L1_clean:
  assumes L1:
    "\<And>rs k. A (RALTS [RALTS rs]) k \<subseteq>
      (\<Union>q \<in> set rs. A (RALTS [q]) k)"
    and seq_head:
...
proof -
  ...
  have sh:
    "card ((single_root (RSEQ r1 r2) k \<union>
      single_term r1 (rsimp4_SEQ_atom r2 k)) -
      (B k \<union> B (rsimp4_SEQ_atom r2 k))) \<le> Suc (rsize r1)"
    using clean by (intro seq_head) auto
  have bnd_d1:
    "card ((B (rsimp4_SEQ_atom r2 k) - B k) \<union>
      (single_term r2 k - B k)) \<le> D1 r2 k"
    using r2_clean clean(4) by (intro boundary) auto
  have child: "D1 r2 k \<le> rsize r2"
    by (rule D1_singleton_le_rsize_from_required_head_suc_boundary_L1_clean
        [OF L1 seq_head boundary])
      (use r2_clean clean(4) in simp_all)
  have bnd:
    "card ((B (rsimp4_SEQ_atom r2 k) - B k) \<union>
      (single_term r2 k - B k)) \<le> rsize r2"
...
lemma combined_RSEQ_le_rsize_from_RALTS_RSTAR_head_boundary_L1_clean:
  assumes L1:
    "\<And>rs k. A (RALTS [RALTS rs]) k \<subseteq>
      (\<Union>q \<in> set rs. A (RALTS [q]) k)"
    and ralts_head:
...
proof -
  have seq_head:
    ...
    by (rule required_seq_head_suc_from_RALTS_RSTAR_cases_clean
        [OF ralts_head rstar_head])
  show ?thesis
    by (rule combined_RSEQ_le_rsize_from_required_head_suc_boundary_L1_clean
        [OF L1 seq_head boundary clean])
qed
...
lemma D1_singleton_le_rsize_from_RALTS_RSTAR_head_boundary_L1_apder_clean:
  assumes L1:
    "\<And>rs k. A (RALTS [RALTS rs]) k \<subseteq>
      (\<Union>q \<in> set rs. A (RALTS [q]) k)"
    and ralts_head:
  ...
  have rseq_combined:
    "\<And>r1 r2 k. apder_clean (RSEQ r1 r2) \<Longrightarrow> apder_clean k \<Longrightarrow>
      card ((single_root (RSEQ r1 r2) k \<union>
        ...
        \<le> rsize (RSEQ r1 r2)"
    by (rule combined_RSEQ_le_rsize_from_RALTS_RSTAR_head_boundary_L1_clean
        [OF L1 ralts_head rstar_head boundary])
      (simp_all add: apder_clean_def)
  show ?thesis
    by (rule D1_singleton_le_rsize_from_combined_RSEQ_L1_apder_clean
        [OF L1 rseq_combined clean])
qed
