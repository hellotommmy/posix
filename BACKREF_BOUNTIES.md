...
| BR-036 | Close rsimp8/rsimp9 live-row cubic closure | 15,000 | 320 | 10 | 15,000 | OPEN | - | GeneralRegexBound.thy:rsimp8_live_row_universe_not_closed,norm18_closes_rsimp8_live_row_obstruction,rsimp8_live_row_universe_RNTIMES_not_closed,norm18_live_row_NTIMES_body_normalized_sanity,rsimp9,RL_rsimp9,rsize_rsimp9_le,rpder_norm9_list,rpder_norm9_rows,rpders_norm19_rows,RLS_rpders_norm19_rows,rpders_norm19_rows_rflts_subsetI,rsizes_rpders_norm19_rows_rsimp9_live_row_cubicI,rsizes_rpders_norm19_rows_rsimp9_path_cubicI,rsizes_rpders_norm19_rows_frontier_universe_cubic,rsizes_rpders_norm19_rows_frontier_universe_cubicI,rsizes_rpders_norm19_rows_rsimp9_frontier_cubicI,rsizes_distinct_path_dual_frontier_universe_cubicI,current_dual_frontier_universe_member_size_not_linear,current_path_atom_frontier_universe_member_size_not_linear,quadratic_plus_linear_padding_bound,quadratic_plus_linear_times_linear_cubic_bound,rflts_singleton_rsimp9_frontier_universe,rflts_map_rsimp9_frontier_subsetI,partial_derivative_frontier_universe_alt_child_mono,rpder_norm9_frontier_universe_step_RZERO,rpder_norm9_frontier_universe_step_RONE,rpder_norm9_frontier_universe_step_RCHAR,rpder_norm9_frontier_universe_step_RALTS_selfI,rpder_norm9_frontier_universe_step_rsimp_ALTsI,rflts_map_rsimp9_rpder_list_frontier_subsetI,rflts_map_rsimp9_rpder_list_norm_tail_frontier_subsetI,rpder_norm9_frontier_universe_step_RSEQ_pathI,rpder_norm9_frontier_universe_step_RSTAR_pathI,rpder_norm9_frontier_universe_step_RNTIMES_pathI,norm19_frontier_universe_repairs_left_nested_seq_counterexample,norm19_frontier_universe_repairs_nested_star_counterexample,rflts_singleton_rsimp9_path_universe,rflts_map_rsimp9_path_subsetI,rflts_map_rsimp9_rpder_list_path_universe_subsetI,rflts_map_rsimp9_rpder_list_norm_tail_path_universe_subsetI,partial_derivative_path_universe_alt_child_mono,rpder_norm9_path_universe_step_RZERO,rpder_norm9_path_universe_step_RONE,rpder_norm9_path_universe_step_RCHAR,rpder_norm9_path_universe_step_RALTS_selfI,rpder_norm9_path_universe_step_rsimp_ALTsI,rpder_norm9_path_universe_step_RSEQ_pathI,rpder_norm9_path_universe_step_RSTAR_pathI,rpder_norm9_path_universe_step_RNTIMES_pathI,rpder_norm9_live_row_step_RSEQ_path_directI,rpder_norm9_live_row_step_RSTAR_path_directI,rpder_norm9_live_row_step_RNTIMES_path_directI,norm19_closes_RNTIMES_countdown_sanity,norm19_RNTIMES_body_normalization_obstruction_persists,norm19_RNTIMES_body_normalization_obstruction_in_path_universe,norm19_path_universe_RNTIMES_subterm_not_closed,norm19_frontier_universe_repairs_RNTIMES_subterm_countdown,rpder_norm8_list,rpder_norm8_rows,rpders_norm18_rows,RLS_rpders_norm18_rows,rsizes_rpders_norm18_rows_rsimp8_live_row_cubicI | Isabelle:Posix | Current `norm17` closure is refuted by `(((1+a).a))*`; checked `norm18 = map rsimp8` repairs that obstruction but the plain target is refuted for `RNTIMES` because `rsimp8` does not recurse under repetition bodies. The proof-level `rsimp9` prototype recursively normalizes `RNTIMES` bodies, collapses zero-count repetitions to `RONE`, preserves language, does not increase `rsize`, closes the simple countdown shape, repairs the old left-nested seq frontier obstruction and the older nested-star cubic obstruction, has checked norm19 live-row/path/frontier cubic hooks, now has checked live-row plus path/frontier constructor splitters, and has a checked dual-frontier conditional cubic hook; however the current full dual universe and old atom-only universe are both checked-false for the needed linear member-size premise, so the next route should be norm9-specific and use root-safe `rsimp9`/`rsimp7_SEQ_atom` continuations or a smaller reachable-row invariant. Full arbitrary-state path-universe closure is checked-false by the counted-tail counterexample; the existing countdown-aware frontier universe repairs that witness and gives the next payout target: prove one-step closure for `partial_derivative_frontier_universe (rsimp9 r)` or a smaller reachable-row invariant before annotated `bsimp` transfer; non-backref fragment only |
