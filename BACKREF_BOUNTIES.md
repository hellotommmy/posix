...
| BR-036 | Close rsimp8 live-row cubic closure | 15,000 | 320 | 10 | 15,000 | OPEN | - | GeneralRegexBound.thy:rsimp8_live_row_universe_not_closed,rpder_norm7_rsimp8_live_row_step,rsizes_rpders_norm17_rows_rsimp8_cubic | Isabelle:Posix | Current naive closure is refuted by `(((1+a).a))*`; next version must add controlled normalized-star images or refine nullable-left sequence normalization, then derive a cubic theorem w.r.t. original `rsize r`; non-backref fragment only |
