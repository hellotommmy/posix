...
def nice_name(metric: str) -> str:
    names = {
        ...
        "strongMemoTree": "deferred strong tree",
        "strongMemoDag": "deferred strong DAG",
        "strongMemoShape": "deferred strong shape DAG",
        "strongMemoAcceptsStates": "memo accepts states",
        "strongMemoValueStates": "memo value states",
        "strongMemoStates": "memo states",
        "strongMemoSplitProbes": "memo split probes",
        "strongMemoQueries": "memo queries",
        "strongMemoSpanBound": "memo span bound",
        "strongMemoSplitBound": "memo split bound",
